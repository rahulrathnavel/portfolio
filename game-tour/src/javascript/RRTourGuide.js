...
export default class RRTourGuide
{
    constructor(_options)
    {
        ...
        // Setup
        this.$container = document.querySelector('.js-rr-tour-guide')
    ...
    setYesNo()
    {
        ...
        this.$yes.addEventListener('click', (event) =>
        {
            ...
            window.localStorage.setItem('rrTourGuidePrevent', 1)
        })

        this.$no.addEventListener('click', (event) =>
        {
            event.preventDefault()
            gsap.delayedCall(1, () =>
            {
...
//             'color: #705df2;'
//         )
        console.log('%cWelcome to Rahul Rathnavel\'s interactive portfolio.', 'color: #32ffce');
        console.log('%cApplied AI/ML, data systems, and product engineering — explore the boards for the work.', 'color: #32ffce');
        console.log('%cMIT derivative attribution is retained in license.md and DERIVATIVE_NOTICE.md.', 'color: #777777');
    }
    ...
    start()
    {
        ...
        window.localStorage.setItem('rrTourGuideSeenCount', this.seenCount + 1)
    }
