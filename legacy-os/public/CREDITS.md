...
This portfolio is a customized deployment of
[daedalOS](https://github.com/DustinBrett/daedalOS) by Dustin Brett, used and
modified under the MIT License. The original desktop engine, window manager,
taskbar, Start menu, File Explorer, and virtual filesystem remain recognizably
daedalOS; Rahul-specific content is supplied through its virtual Public desktop.

The **RR Game Tour** is Rahul's customized derivative of
[brunosimon/folio-2019](https://github.com/brunosimon/folio-2019), also used
under its MIT License. Its derivative notice and license remain in the
repository's `game-tour/` directory.
